...
const Contact = compose(injectState, withApi)(({ effects: { setModal }, api, profile, canEdit, mt }) => {
  const {
    addressLine1,
    addressLine2,
    institution,
  ...
  return (
    <Box mt={mt}>
      ...
      <PrivacyWrap accessor={["addressLine1", "addressLine2", "institution", "city", "country", "state", "institutionalEmail", "phone"]} profile={profile}>
